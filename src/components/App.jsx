...
function App() {
  return (
    <>
      <div className="bg-hero-pattern bg-cover bg-center bg-no-repeat sm:px-10 px-4 text-white sm:h-screen w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:space-x-24 items-center">
          <div className="sm:mt-14 pt-14 sm:pt-0 sm:pl-28 pl-4 text-3xl sm:text-5xl sm:space-y-1 font-['Inter'] font-bold ">
      ...
      <div className="bg-[#fff] headings sm:mx-12">
