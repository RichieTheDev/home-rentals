...
const Footer = () => {
  return (
    <div className="text-lg mt-16 border-t border-[#F4511E] mx-4 sm:mx-14">
      ...
      <div className="flex flex-col sm:flex-row pb-6 sm:text-sm text-base">
        <p>About Us</p>
        <p className="sm:ml-6">Contact Us</p>
        <p className="sm:ml-6">Help</p>
        <p className="sm:ml-6">Privacy Policy</p>
        <p className="sm:ml-6">Disclaimer</p>
        <div className="flex sm:ml-auto text-sm sm:text-xs">
