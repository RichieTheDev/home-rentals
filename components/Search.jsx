...
const Search = () => {
  return (
    <div className="mt-14 bg-white font-['Inter']">
        ...
        <div className="flex mr-auto sm:mr-0 flex-col ">
          <div>
            <img
              src={Img1}
              alt="/"
              className="w-[8.5rem] h-[11.5rem] sm:w-40 sm:h-52  brightness-75 object-cover rounded-2xl absolute"
            />
            <p className="relative ml-4 sm:ml-6 top-4 text-white leading-none  text-center">
              Flexible Leases
            </p>
          </div>
          <div className="mt-52">
            <img
              src={Img3}
              alt="/"
              className="w-32 h-40 sm:w-36 sm:h-44 brightness-75 object-cover rounded-2xl absolute"
            />
            <p className="relative sm:ml-2 ml-0.5 top-4 text-white leading-none  text-center">
              Monthly House
              <p>Cleaning</p>
            </p>
          </div>
      ...
      <div className="text-[#252B42] font-['Poppins'] lg:shadow-2xl rounded-md mt-4 p-4 lg:p-10 mx-4 lg:mx-32 ">
      ...
      <div className="flex sm:flex-row flex-col-reverse mt-10 bg-gradient-to-r from-pink-100 to-pink-100">
        ...
        <img
          src={IMG}
          alt="/"
          className="sm:flex-1 w-screen px-2 sm:px-0 rounded-md sm:w-20 lg:h-80 object-cover brightness-75"
        />
      </div>
    </div>
  );
